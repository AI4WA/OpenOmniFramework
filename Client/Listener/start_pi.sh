...
# Sync files process
nohup  python3 storage.py  --token c284262e850b8ac98e9174db620dc246ea6d9043 --api_domain http://192.168.50.113:8000 --dest_dir jarv5@192.168.50.113 --dest_password jarv5 > sync_files.log 2>&1 &
