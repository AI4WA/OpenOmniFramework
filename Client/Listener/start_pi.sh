...
nohup python3 audios_acquire.py --token c284262e850b8ac98e9174db620dc246ea6d9043 --track_cluster CLUSTER_Q_ETE_CONVERSATION --api_domain http://192.168.50.113:8000 --default_microphone "USB Device 0x46d:0x825" > audios_acquire.log 2>&1 &
